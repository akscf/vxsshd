...
int vxssh_test_aes_ctr() {
    int err = OK;

    vxssh_cipher_alg_props_t cip_cfg = {"aes128-ctr", VXSSH_CIPHER_AES, VXSSH_CIPHER_MODE_CTR, VXSSH_CIPHER_AES_BLOCK_SIZE, 16 , 0};
    ...
    vxssh_log_debug("Cipher test: AES128-CTR...");
